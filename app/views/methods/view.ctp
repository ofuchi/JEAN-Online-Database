...
<h2><?php  __('Method');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $method['Method']['comment']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Created'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $method['Method']['created']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Modified'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $method['Method']['modified']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Method', true), array('action' => 'edit', $method['Method']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Method', true), array('action' => 'delete', $method['Method']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $method['Method']['id'])); ?> </li>
