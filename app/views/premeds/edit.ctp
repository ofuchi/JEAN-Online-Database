...
<?php echo $this->Form->create('Premed');?>
	<fieldset>
		<legend><?php __('Edit Premed'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Premed.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Premed.id'))); ?></li>
