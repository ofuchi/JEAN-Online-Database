...
<?php echo $this->Form->create('Relaxant');?>
	<fieldset>
		<legend><?php __('Edit Relaxant'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Relaxant.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Relaxant.id'))); ?></li>
