<div class="relaxants view">
<h2><?php  __('Relaxant');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $relaxant['Relaxant']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $relaxant['Relaxant']['name']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Comment'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $relaxant['Relaxant']['comment']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Created'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $relaxant['Relaxant']['created']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Modified'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $relaxant['Relaxant']['modified']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Relaxant', true), array('action' => 'edit', $relaxant['Relaxant']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Relaxant', true), array('action' => 'delete', $relaxant['Relaxant']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $relaxant['Relaxant']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($relaxant['Trial'] as $trial):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
